...
/******/ 	var hotCurrentHash = "6b9bdb8f9f6815bdc58e"; // eslint-disable-line no-unused-vars
...
/******/ 	return hotCreateRequire("./source/components/AddTodo.js")(__webpack_require__.s = "./source/components/AddTodo.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__List__ = __webpack_require__("./source/components/List.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__stateToProps__ = __webpack_require__("./source/components/stateToProps.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__redux_store_store__ = __webpack_require__("./source/redux/store/store.js");
...
class AddTodo extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        ...
        this.getData = function () {
            fetch(_this.state.url).then(function (res) {
                return res.json();
            }).then(function (data) {
                _this.setState({
                    todos: data
        ...
        this.addItem = function () {
            const todo = _this._inputElement.value;
            fetch(_this.state.url, {
                ...
                _this.setState({
                    todos: [..._this.state.todos, todo]
                });
            }).catch(console.error);
            _this._inputElement.value = "";
        };

        this.editMode = function (_id) {
            const it = _this.state.todos.filter(function (item) {
                return item._id === _id;
            })[0];
            _this._inputElement.value = it.todo;
            _this.setState({
                editMode: _this.editItem,
                editId: _id
            });
        };
        ...
        this.editItem = function () {
            event.preventDefault();
            fetch(_this.state.url + _this.state.editId, {
                method: 'PUT',
                body: JSON.stringify({
                ...
                const updated = _this.state.todos.map(function (item) {
                ...
                _this.setState({
                    todos: updated,
                    editMode: _this.addItem
                });
            }).catch(console.error);
        };

        this.deleteItem = function (_id) {
            fetch(_this.state.url + _id, {
                method: 'delete'
            }).then(function (res) {
                return res.json();
            }).then(function (todo) {
                const updated = _this.state.todos.filter(function (item) {
    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            { className: 'addtodo' },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { key: 'addtodo', placeholder: 'enter task', ref: function (a) {
                    return _this2._inputElement = a;
                } }),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'button',
                { type: 'submit', ref: function (a) {
                        return _this2.buttonElem = a;
                    }, onClick: this.state.editMode },
                'add'
            ),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__List__["a" /* default */], { todos: this.state.todos, edit: this.editMode, 'delete': this.deleteItem, input: this._inputElement, addbutton: this.buttonElem })
        );
    }
}
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    Provider,
    { store: true },
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(AddTodo, null)
), document.getElementById('app'));

connect(__WEBPACK_IMPORTED_MODULE_3__stateToProps__["b" /* mapStateToProps */], __WEBPACK_IMPORTED_MODULE_3__stateToProps__["a" /* mapDispatchToProps */])(AddTodo);
...
/***/ "./source/components/stateToProps.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = mapStateToProps;
/* harmony export (immutable) */ __webpack_exports__["a"] = mapDispatchToProps;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__redux_reducers_todoReducer__ = __webpack_require__("./source/redux/reducers/todoReducer.js");
...
function mapDispatchToProps(dispatch) {
  return {
    addTodo: function () {
      return dispatch(Object(__WEBPACK_IMPORTED_MODULE_0__redux_reducers_todoReducer__["a" /* addTodo */])());
    },
    deleteTodo: function () {
      return dispatch(Object(__WEBPACK_IMPORTED_MODULE_0__redux_reducers_todoReducer__["c" /* deleteTodo */])());
    },
    editTodo: function () {
      return dispatch(Object(__WEBPACK_IMPORTED_MODULE_0__redux_reducers_todoReducer__["d" /* editTodo */])());
    },
    getTodos: function () {
      return dispatch(Object(__WEBPACK_IMPORTED_MODULE_0__redux_reducers_todoReducer__["e" /* getTodos */])());
    }
  };
};
...
/***/ "./source/redux/reducers/todoReducer.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = addTodo;
/* harmony export (immutable) */ __webpack_exports__["c"] = deleteTodo;
/* harmony export (immutable) */ __webpack_exports__["d"] = editTodo;
/* harmony export (immutable) */ __webpack_exports__["e"] = getTodos;
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* unused harmony export GET_TODOS */


/* harmony default export */ __webpack_exports__["b"] = (todoReducer = function (state = INITIAL_STATE, action) {
    switch (action.type) {
        case GET_TODOS:
        ...
        case EDIT_TODO:
            return _extends({}, state, {
                todos: state.todos.map(function (todo) {
                    if (todo.id !== payload.id) todo.todo = payload.todo;
                    return todo;
                })
            });
        default:
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__reducers_todoReducer__ = __webpack_require__("./source/redux/reducers/todoReducer.js");




const store = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["b" /* createStore */])(__WEBPACK_IMPORTED_MODULE_2__reducers_todoReducer__["b" /* default */], Object(__WEBPACK_IMPORTED_MODULE_0_redux__["a" /* applyMiddleware */])(__WEBPACK_IMPORTED_MODULE_1_redux_thunk___default.a));
